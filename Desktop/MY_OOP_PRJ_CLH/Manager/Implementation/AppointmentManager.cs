class AppointmentManager : IAppointmentManager
{
    ...
    public void BookAppointment()
    {
        ...
        {
            Console.WriteLine($"{doctor.FirstName} {doctor.LastName}    {doctor.DoctorFieldOfSpecialization}    {doctor.DoctorID}  {doctor.DoctorStatus}");
        }
        ...
        Patient.PatientFile = lodgeComplain;
